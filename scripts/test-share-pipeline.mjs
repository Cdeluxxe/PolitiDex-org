...
// ═════════════════════════════════════════════════════════════════════════════
{
  ...
  ok(dossier === "https://politidex.fyi/p/scalise?record=scalise~voting_rights",
  ...
  ok(SL.forTarget({ pid: "jayapal", issueKey: "healthcare" })
       === "https://politidex.fyi/p/jayapal?record=jayapal~healthcare",
     "link: the same holds for any (member, issue) pair, not just the reported one");
  ok(SL.record("null", "healthcare") === "https://politidex.fyi/" &&
     SL.record("", "healthcare") === "https://politidex.fyi/",
