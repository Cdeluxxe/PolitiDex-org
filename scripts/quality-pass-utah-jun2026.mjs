...
const TENURE = {
  ...
  harper_s16: '2013-01', kcullimore: '2019-01', mckell_s25: '2021-01',
...
const BIOS = {
  ...
  // Re-keyed from `cullimore_s19`, retired by the identity merge (see
  // db/vr-pid-aliases.json): the canonical id is `kcullimore`, so a re-run
  // tops up the surviving record instead of re-creating the duplicate.
  kcullimore: "Kirk Cullimore is a Sandy attorney who serves in Senate Republican leadership and has become a key player on technology and consumer-protection law. He was a lead Senate sponsor of Utah's pioneering laws restricting minors' use of social media and requiring parental consent — measures that put the state at the front of a national movement and drew immediate legal challenges from the tech industry. He balances that high-profile tech work with bread-and-butter judiciary, landlord-tenant, and consumer-finance legislation drawn from his legal practice.",
