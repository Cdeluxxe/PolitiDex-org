// ─────────────────────────────────────────────────────────────────────────────
// vr-gen-house-migration.mjs — deploy-time migration for the House 119/s2 seed
// ─────────────────────────────────────────────────────────────────────────────
// The House twin of scripts/vr-gen-senate-migration.mjs. It reads the curated House
// seed (db/vr-house-seed-119-s2.json) plus the curated issue map (db/vr-issue-seed
// .json) and the member map, and prints an idempotent SQL migration to stdout:
//
...
// row and re-applying it is a no-op. Changes NO schema.
...
const seed = JSON.parse(readFileSync(resolve(REPO, "db/vr-house-seed-119-s2.json"), "utf8"));
...
L.push("-- ─────────────────────────────────────────────────────────────────────────────");
L.push("-- GENERATED by scripts/vr-gen-house-migration.mjs from db/vr-house-seed-119-s2.json");
